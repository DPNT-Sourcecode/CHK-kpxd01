...
def test_get_total_price():
    ...
    assert cs.get_total_price({"K": 1}) == 70
    ...
    assert cs.get_total_price({"S": 1}) == 20
    ...
    assert cs.get_total_price({"X": 1}) == 17
    assert cs.get_total_price({"Y": 1}) == 20
    assert cs.get_total_price({"Z": 1}) == 21
    ...
    assert cs.get_total_price({"F": 2}) == 20
    assert cs.get_total_price({"F": 3}) == 30
    assert cs.get_total_price({"F": 4}) == 40
    assert cs.get_total_price({"H": 5}) == 45
    assert cs.get_total_price({"H": 7}) == 65
    assert cs.get_total_price({"H": 10}) == 80
    assert cs.get_total_price({"K": 2}) == 120
    assert cs.get_total_price({"K": 3}) == 190
    assert cs.get_total_price({"N": 3, "M": 1}) == 135
    assert cs.get_total_price({"N": 6, "M": 2}) == 270
    ...
    assert cs.get_total_price({"S": 3}) == 45
    assert cs.get_total_price({"S": 4}) == 65
    assert cs.get_total_price({"T": 3}) == 45
    assert cs.get_total_price({"T": 4}) == 65
    assert cs.get_total_price({"X": 3}) == 45
    assert cs.get_total_price({"X": 4}) == 62
    assert cs.get_total_price({"Y": 3}) == 45
    assert cs.get_total_price({"Y": 4}) == 65
    assert cs.get_total_price({"Z": 3}) == 45
    assert cs.get_total_price({"Z": 4}) == 66

    assert cs.get_total_price({"S": 2, "Z": 3}) == 85
    assert cs.get_total_price({"S": 3, "X": 2}) == 79
    assert cs.get_total_price({"S": 2, "X": 3, "Z": 2}) == 107
...
def test_single_items():
    ...
    assert cs.checkout("S") == 20
    assert cs.checkout("T") == 20
    assert cs.checkout("U") == 40
    assert cs.checkout("V") == 50
    assert cs.checkout("W") == 20
    assert cs.checkout("X") == 17
    assert cs.checkout("Y") == 20
    assert cs.checkout("Z") == 21
...
def test_combined_discounts():
    ...
    assert cs.checkout("UUUUBBB") == 195
